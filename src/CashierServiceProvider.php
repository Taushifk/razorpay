...
use Taushifk\Razorpay\Components\Checkout;
...
class CashierServiceProvider extends ServiceProvider
{
    ...
    {
        Blade::directive('razorpayJS', function () {
    ...
    {
        Blade::component('cashier::components.button', 'razorpay-button');
        Blade::component(Checkout::class, 'razorpay-checkout');
    }
}